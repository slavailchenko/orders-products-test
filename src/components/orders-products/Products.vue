        ...
        >
          <v-card
            ...
            tile>
              ...
              <v-card-text class="pt-0 overline">
          ...
          <v-card
            ...
            <v-list-item two-line>
              <v-list-item-content>
                <v-list-item-title> {{ product.guarantee.start | toDate }} </v-list-item-title>
                <v-list-item-title> {{ product.guarantee.end | toDate }} </v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </v-card>
          <v-card
...
import { toDate, toDateWithoutDay, toCurrency, fixed, toImage } from '../../filters';

export default {
  name: 'Products',
  filters: { toDate, toDateWithoutDay, toCurrency, fixed, toImage },
  computed: {
  },
  data() {
    return {
